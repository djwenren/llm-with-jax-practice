...
RUN_XPROF_PROFILER=False
# XPROF_OUTPUT_FILEPATH="${CHECKPOINT_DIR}/xprof-profile-data"
XPROF_OUTPUT_FILEPATH=""

# Training config
# https://colab.research.google.com/drive/1RlUQe0Db2tUoV7Ui3l7Zld931jYIj3sO
NUM_STEPS=13001
...
COSINE_ONECYCLE_MAX_LEARNING_RATE=8e-3
COSINE_ONECYCLE_MIN_LEARNING_RATE=-1
COSINE_ONECYCLE_WARMUP_ITERS=800
COSINE_ONECYCLE_COSINE_CYCLE_ITERS=12201
USE_MU_P=True
NUM_MICROBATCHES=1
...
XLA_PYTHON_CLIENT_PREALLOCATE=false ${TRAIN_CMD} \
  ...
  --run_xprof_profiler="${RUN_XPROF_PROFILER}" \
  --xprof_output_filepath="${XPROF_OUTPUT_FILEPATH}"